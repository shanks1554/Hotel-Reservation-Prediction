    ...
    def preprocess_data(self,df):
        try:
            ...
            for col in cat_cols:
                ...
                mappings[col] = {label:code for label, code in zip(label_encoder.classes_, label_encoder.transform(label_encoder.classes_))} # Stores all the mappings in mapping dictionary
            ...
            raise CustomException("Error while preprcess data", e)
